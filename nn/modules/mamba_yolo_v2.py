...
__all__ = ("VSSBlock", "SimpleStem", "VisionClueMerge", "XSSBlock","VSSBlock")
...
class RGBlock(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.,
        ...
        # self.gpconv = RepConv(hidden_features, hidden_features, k=3, s=1, p=1, g=1, d=1, act=True, bn=False, deploy=False)
        self.act = act_layer()
